...
inline std::ofstream& fileLogger() {
	static std::ofstream logfile("./test/test_data/log.txt");
	return logfile;
}
...
/* get user time used "ru_utime" from rusage */
...
class function_iterator: public std::iterator<std::forward_iterator_tag,
